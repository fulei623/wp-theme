...
if (git_get_option('git_footcode')) echo git_get_option('git_footcode'); ?> <span class="yunluocopyright">Theme by <a id="yunluo" href="www.mydrones.com.cn" title="MyDrones" target="_blank" style="cursor:help;">MyDrones</a></span>
